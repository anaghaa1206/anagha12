...
The database shows the search history of the stocks that were serached and keeps track of what the user entered into the serach bar.
...
From VSCode model, show your unique code that was created to initialize table and create test data. (11-20)
...
In the debugger terminal, the keys are in purple and the values are in orange.
...
POST:
I used the POST method to request data of the stock that the user wishes to enter.
...
GET:
I used the GET method recieve information about the stocks from the Alpha Vantage API. 

I am working on the update method. I will use it to change the entries that the user put into the log.
